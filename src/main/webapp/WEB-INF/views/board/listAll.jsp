	...
	<section id="portfolio" class="module-sm">
		...
		<c:forEach items="${list}" var="boardVO">
			...
			<div class="works-grid-wrapper">
	            ...
	            <div class="work-item">
	            	<a class="thumbnail" href="#" data-image-id="${boardVO.boa_snum}" data-toggle="modal" data-title="${boardVO.boa_subject}" data-caption="${boardVO.boa_context}"
	            		 data-image="/displayFile?fileName=${boardVO.boa_imgpng }" data-target="#image-gallery">
	                	<img class="img-responsive" src="/displayFile?fileName=${boardVO.boa_imgpng }" alt="Short alt text">
	            	</a>
	        	</div>
            ...
            <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal">&times;</button>
               	...
               	<div class="comment clearfix" style="height: 80px">
					...
					<c:forEach items="${list}" var="boardVO">
						<img src="/displayFile?fileName=${boardVO.mem_profile}" alt="">
							<script>alert("프로필"+'${boardVO.mem_profile }');</script>
					</c:forEach>
					...
					<div class="comment-content clearfix">
						...
						<c:forEach items="${list}" var="boardVO">
							<a href="#">${boardVO.mem_id}</a>
							<script>alert('${boardVO.mem_id }');</script>
						</c:forEach>	
						</h5>
						<div class="comment-body">
							...
							<button type="button" id="addfriend-btn" class="label label-primary" value="${boardVO.mem_id}">Following</button>
						...
						<div class="comment-meta font-alt">${boardVO.boa_regdate}</div>
					</div>
